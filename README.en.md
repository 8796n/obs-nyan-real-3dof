...
(XREAL, RayNeo, EPSON MOVERIO and Rokid) and warps an OBS source as a head-tracked virtual screen.
...
1. Connect supported glasses (XREAL / RayNeo / EPSON MOVERIO / Rokid) by USB and make sure they
   enumerate as HID.
2. Start OBS.
...
series, EPSON MOVERIO BT-40, Rokid Max / Air) is auto-detected over HID; the connection and warp start only after HID
