...
display FOV; turn off `Auto FOV from device` to set the FOV manually. See
[docs/devices.md](docs/devices.md) for the per-model resolution, diagonal FoV,
device-specific features, and hardware-verification status.
