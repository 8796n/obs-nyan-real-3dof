...
HID で判別した AR グラス（XREAL / RayNeo / EPSON MOVERIO）の IMU データを読み取り、OBS のソースを
...
1. 対応するグラス（XREAL / RayNeo / EPSON MOVERIO）を USB で接続し、HID デバイスとして認識させます。
2. OBS を起動します。
...
機種（XREAL One / One Pro / 1S / ROG XREAL R1 / Air / Air 2、RayNeo Air 系、EPSON MOVERIO BT-40）は HID で
